    ...
    <div>
      ...
      <Link to ="/auntys-cafe/preorder">
        <button
          ...
          className="fixed bottom-40 right-6 bg-green-400 hover:bg-green-500 text-black-600 px-4 py-2 rounded-md shadow-md"
        >
          Order Nowww
        </button>
      </Link>
      ...
      <Link to ="/my-orders">
        <button
          ...
          className="fixed bottom-4 right-6 bg-yellow-400 hover:bg-yellow-500 text-red-600 px-4 py-2 rounded-md shadow-md"
        >
          Your orders
        </button>
      </Link>
